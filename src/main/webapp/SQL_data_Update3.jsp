...
try{
	...
	String sql = "update ducat_inst set Name=?, Email=?, Phone=?, Address=? where Id='"+id+"'";
...
if(i>0)
{
	response.sendRedirect("SQL_data_display.jsp?msg=done");
}
else
{
	response.sendRedirect("SQL_data_display.jsp?msg=not-done");
}
%>
</body>
</html>